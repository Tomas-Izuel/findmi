...
function GridHomeDesktop() {
  return (
    <section className="hidden size-full max-h-screen md:grid relative w-full">
      ...
      <div className="absolute grid items-center justify-items-end inset-y-0 right-0 w-3/4 bg-gradient-to-l from-[rgb(0,0,0)] via-[rgba(0,0,0,0.86)] to-transparent text-Therciary_color">
        <div className="w-1/2 grid gap-7 p-3.5">
          ...
          <p className="text-gray-200">
            Conecta con músicos talentosos en tu área. Encuentra el guitarrista,
          ...
          <div className="flex flex-col gap-3.5">
            <Link
              ...
              className={buttonVariants({
                variant: "ghost",
                className:
                  "border-2 self-center w-full !py-5 max-w-64 xl:max-w-96 !rounded-2xl text-button-quaternary hover:bg-button-quaternary hover:text-secondary_color group border-button-quaternary",
              })}
            >
              Registrarme
            ...
            <Link
              ...
              className={buttonVariants({
                variant: "ghost",
                className:
                  "border-2 self-center group w-full !py-5 max-w-64 xl:max-w-96 !rounded-2xl text-primary_color hover:bg-primary_color hover:text-Therciary_color border-primary_color",
              })}
            >
              Buscar un músico
