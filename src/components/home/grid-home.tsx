  ...
  return (
    <section className="md:hidden size-full max-h-screen relative w-full">
      <div className="grid absolute size-full grid-cols-3 gap-3.5 text-Therciary_color">
        ...
        <div className="grid grid-rows-3 col-start-2 col-end-4 gap-3.5">
          <div className="flex flex-col justify-between gap-3.5">
            ...
            <div className="flex flex-col gap-3.5">
              <Button
                variant="ghost"
                className="border-2 rounded-xl self-start text-xs min-[450px]:text-base text-button-quaternary hover:bg-button-quaternary hover:text-secondary_color group border-button-quaternary"
              >
                Registrarme
              ...
              <Button
                variant="ghost"
                className="border-2 rounded-xl self-start text-xs group min-[450px]:text-base text-primary_color hover:bg-primary_color hover:text-Therciary_color border-primary_color"
              >
                Buscar un músico
          ...
          <div className="relative rounded-lg row-start-2 row-end-4">
            <Image
